<template>
    ...
    <div class="relative">
        ...
        <img src="/mockup3fmain.jpg" alt="" class="filter contrast-150 brightness-75 h-[16rem] w-full object-cover absolute sm:h-[24rem] xl:h-[36rem]">
    ...
    <div class="uppercase mt-[23rem] sm:mt-[30rem] xl:mt-[40rem] absolute w-full">
        ...
        <div class="font-fantome md:text-5xl text-4xl mx-8 md:mx-32 flex flex-col mt-14 mb-24">
            ...
            <div class="self-end flex items-center space-x-2 md:space-x-8">
