<template>
    ...
    <div class="relative">
        ...
        <img src="/Hotones.jpg" alt="" class="filter contrast-150 brightness-95 h-[16rem] w-full object-cover absolute sm:h-[24rem] xl:h-[36rem]">

        <h1 class="absolute font-fantome uppercase text-blue-700 mt-[12.5rem] text-[7vw] ml-[1rem] sm:mt-[17.5rem] xl:mt-[28rem] xl:ml-20 xl:text-[6vw]">Hot ones</h1>
    </div>

    <div class="uppercase mt-[23rem] sm:mt-[30rem] xl:mt-[40rem] absolute w-full">
        <h2 class="font-mademedium mb-8 md:text-2xl  mx-8 md:mx-20 text-xl">Projet vidéo</h2>
        <div class="font-maderegular flex flex-col md:flex-row md:space-x-20 space-y-2 md:space-y-0 justify-start mb-8 text-lg md:text-base mx-20">
            <p>Novembre<span class="text-blue-700"> 2022</span></p>
            <p>Projet <span class="text-blue-700">étudiant</span></p>
            <p>Premiere Pro<span class="text-blue-700"> | </span> After effects<span class="text-blue-700"> | </span>Illustrator<span class="text-blue-700"> | </span>Photoshop</p>
        </div>
        ...
        <div class="font-fantome md:text-5xl text-4xl mx-8 md:mx-32 flex flex-col mt-14 mb-24">
            ...
            <RouterLink to="/newave" class="self-end flex items-center space-x-2 md:space-x-8">
